...
// Chapter 04 — Alter Ego. A storybook page: the team's own illustrated
// logo sits like a wax seal at the top of the room, and the narrative reads
// like the opening page of a children's book rather than a feature list.
  ...
  return (
    <section id={team.slug} style={{ background: '#EAF4EA', padding: '110px 24px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: `repeat(${team.storyBeats.length}, 1fr)`, gap: 12, margin: '8px 0 32px' }} className="aql-level-grid">
